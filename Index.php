...
<head>
    ...
    <title>Inicio de Sesión-Requena</title>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-center py-4">
                                                <img src="assets/img/logo-econocable-1.png" alt="Logo"
                                                    style="width: 300px; height: auto;">
                                            </div><!-- End Logo -->

                                            <div class="pb-2">
                                                <h5 class="card-title text-center pb-0 fs-4">Ingrese a su cuenta
                                                </h5>
                                            ...
                                            <form method="post" action="" class="row g-3 needs-validation" novalidate>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group has-validation">
                                                        ...
                                                        <input type="text" class="form-control" id="numeDocu"
                                                            name="numeDocu" required>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group has-validation">
                                                        ...
                                                        <input type="password" class="form-control" id="passClie"
                                                            name="passClie" required>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="col-12">
                                                        <button class="btn btn-primary w-100" type="submit"
                                                            style="background-color: #781f82; border: 2px solid #781f82;">Iniciar
                                                            sesión</button>
                                                    </div>
