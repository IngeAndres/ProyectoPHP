...
<style>
	...
	*{
    ...
    position: absolute;
    left: 50%;
    top: 10%; /* Ajusta el porcentaje según sea necesario */
...
#info_adicional {
    border: 1px solid black; /* Color negro para el borde */
    padding: 10px; /* Espacio interno alrededor del contenido */
    margin-top: 20px; /* Espacio superior entre el contenido anterior y este bloque */
    width: 50%; /* Ancho del bloque (ajusta según sea necesario) */
    margin-left: auto; /* Centrar el bloque horizontalmente */
    margin-right: auto; /* Centrar el bloque horizontalmente */
}
...
<body>
<img class="anulada" src="img/anulado.png" alt="Cancelado">
<div id="page_pdf">
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
						<td><label>Nombre:</label> <p><?php echo $row['raznSociClie']?></p></td>
						<td><label>Celular 1:</label> <p><?php echo $row['celuClie']?></p></td>													
						</tr>
						<tr>
							<td><label>Dirección:</label> <p><?php echo $row['direccion']?></p></td>
							<td><label>Celular 2:</label> <p><?php echo $row['celuClie2']?></p></td>							
						</tr>
						<tr>
							<td><label>RUC/DNI:</label><p><?php echo $row['numeDocu']?></p></td>
							<td><label>Fecha de venc.:</label> <p><?php echo $row['fechVenc']?></p></td>					
						</tr>
					</table>
				</div>
			</td>
...
<script>
    ...
    // Formatear la hora
    var optionsHora = { hour: '2-digit', minute: '2-digit', hour12: true };
